...
public class RenderMagReaderWriter extends TileEntitySpecialRenderer<TileEntityMagReaderWriter> {
    ...
    @Override
    public void renderTileEntityAt(TileEntityMagReaderWriter te, double x, double y, double z, float partialTicks,
                                   int destroyStage) {
        GL11.glPushMatrix();
    ...
    public static class RenderMagReaderWriterItem extends TileEntityItemStackRenderer {
        ...
        public void renderByItem(ItemStack stack) {
            ...
            TileEntityRendererDispatcher.instance.renderTileEntityAt(magReaderWriter, 0, 0, 0, 0);
        }
    }
}
