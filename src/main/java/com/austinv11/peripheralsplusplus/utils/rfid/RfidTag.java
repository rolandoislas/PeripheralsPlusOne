...
public class RfidTag {
    ...
    public static boolean hasTag(ItemStack itemStack) {
        return itemStack != null && itemStack.getTagCompound() != null && itemStack.getTagCompound().hasKey(RFID_TAG);
    }
    ...
    private void readFromNbt(NBTTagCompound compound) {
        ...
        int blockIndex = 0;
        for (int tagIndex = 0; tagIndex < blockList.tagCount(); tagIndex++) {
            NBTBase blockBase = blockList.get(tagIndex);
        ...
        if (compound.hasKey("display")) {
            ...
            if (display.hasKey("Lore")) {
                ...
                for (int tagIndex = 0; tagIndex < lore.tagCount(); tagIndex++) {
                    NBTBase loreString = lore.get(tagIndex);
